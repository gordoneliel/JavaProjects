...
class GenTreeOps
{
	...
	public static int height(GenNode tree)
	{
		if (tree == null)
			return 0;
		return MAX(1 + height(tree.leftchild()), height(tree.rightsib()));
	}
	...
	/*
	 * Input: A general tree Return value: The number of leaves in the tree
	 */
	public static int numLeaves(GenNode tree)
	{
		...
		for (GenNode tmp = tree.leftchild(); tmp != null; tmp = tmp.rightsib())
		{
			totalLeaves += numLeaves(tmp);
		}
	...
	public static void main(String args[]) throws IOException
	{
		...
		tree1 = new GenNode(new Integer(1), new GenNode(new Integer(2), null,
				new GenNode(new Integer(3), new GenNode(new Integer(5), null,
						new GenNode(new Integer(6), null, new GenNode(
								new Integer(7), null, null))), new GenNode(
						new Integer(4), null, null))), null);

		tree2 = new GenNode(new Integer(1), new GenNode(new Integer(2),
				new GenNode(new Integer(3), new GenNode(new Integer(4),
						new GenNode(new Integer(5), null, null), null), null),
				null), null);

		tree3 = new GenNode(new Integer(1), new GenNode(new Integer(2),
				new GenNode(new Integer(5), null, new GenNode(new Integer(6),
						null, null)), new GenNode(new Integer(3), null,
						new GenNode(new Integer(4), new GenNode(new Integer(7),
								null,
								new GenNode(new Integer(8), null, new GenNode(
